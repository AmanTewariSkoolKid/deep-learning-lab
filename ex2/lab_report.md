...
To implement a Basic Neural Network for Binary Classification using the Titanic Dataset. This experiment demonstrates:
- Data preprocessing and feature engineering
- Building a simple feedforward neural network with TensorFlow/Keras
- Training and evaluating the model
- Performance analysis using Accuracy, Precision, Sensitivity (Recall), and Specificity
- Visualizing training metrics (accuracy and loss curves)
...
![Accuracy and Loss Curves](./image/output.png)

*Screenshot: Training and validation accuracy/loss curves over 30 epochs showing model convergence.*
